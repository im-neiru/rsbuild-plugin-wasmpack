...
`rsbuild-plugin-wasmpack` is a plugin for [Rsbuild](https://rsbuild.dev/) that enables you to compile Rust crates into WebAssembly (Wasm) using [`wasm-pack`](https://wasm-bindgen.github.io/wasm-pack/). It simplifies integration of Rust code into web applications with support for hot-reloading, crate aliasing, and automatic Rust toolchain management.
